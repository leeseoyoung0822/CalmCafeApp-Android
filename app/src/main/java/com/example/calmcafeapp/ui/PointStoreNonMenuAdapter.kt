...
import com.example.calmcafeapp.databinding.ItemRegPointstoreNonMenuBinding

class PointStoreNonMenuAdapter(
...
) : RecyclerView.Adapter<PointStoreNonMenuAdapter.MenuViewHolder>() {

    class MenuViewHolder(private val binding: ItemRegPointstoreNonMenuBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuViewHolder {
        val binding = ItemRegPointstoreNonMenuBinding.inflate(
    ...
    fun updateMenus(newMenus: List<PointDiscount>) {
        menus = newMenus
